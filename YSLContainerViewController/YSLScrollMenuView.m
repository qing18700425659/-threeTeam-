...
static const CGFloat kYSLIndicatorHeight = 20;
...
- (void)setItemTitleArray:(NSArray *)itemTitleArray
{
    if (_itemTitleArray != itemTitleArray) {
        ...
        _indicatorView.frame = CGRectMake(10, (_scrollView.frame.size.height - kYSLIndicatorHeight)/2, kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
        _indicatorView.backgroundColor = self.itemIndicatorColor;
        _indicatorView.layer.cornerRadius = 10.0f;
...
- (void)setIndicatorViewFrameWithRatio:(CGFloat)ratio isNextItem:(BOOL)isNextItem toIndex:(NSInteger)toIndex
{
    ...
    _indicatorView.frame = CGRectMake(indicatorX, (_scrollView.frame.size.height - kYSLIndicatorHeight)/2, kYSLScrollMenuViewWidth, kYSLIndicatorHeight);
